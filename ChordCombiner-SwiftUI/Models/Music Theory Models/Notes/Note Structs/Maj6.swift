...
struct Maj6: NoteProtocol, CustomStringConvertible, KSwitch, Codable {
  ...
  var degName: (name: String, short: String, long: String) {
    return (name: Degree.major6th.name, short: Degree.major6th.short, long: Degree.major6th.long)
  }
