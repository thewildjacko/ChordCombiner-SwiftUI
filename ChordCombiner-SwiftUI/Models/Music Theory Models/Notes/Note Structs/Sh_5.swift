...
struct Sh_5: NoteProtocol, CustomStringConvertible, KSwitch, Codable {
  ...
  var degName: (name: String, short: String, long: String) {
    return (name: Degree.sharp5th.name, short: Degree.sharp5th.short, long: Degree.sharp5th.long)
  }
