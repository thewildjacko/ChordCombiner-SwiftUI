...
struct Sh_9: NoteProtocol, CustomStringConvertible, KSwitch, Codable {
  ...
  var degName: (name: String, short: String, long: String) {
    return (name: Degree.sharp9th.name, short: Degree.sharp9th.short, long: Degree.sharp9th.long)
  }
