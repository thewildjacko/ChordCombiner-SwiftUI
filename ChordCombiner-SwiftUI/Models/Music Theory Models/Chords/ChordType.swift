...
enum ChordType: String, CaseIterable, Identifiable, Comparable {
  ...
  func setNotes(root: Root, rootKey: RootGen) -> [Note] {
    ...
    case .mi7_b5b13:
      // [0, 3, 6, 8, 10]
      return [root, Min3(rootKey), Dim5(rootKey), Min6(rootKey), Min7(rootKey)]
    ...
    case .dim11: // [0, 2, 3, 5, 6, 9]
      return [root, Maj9(rootKey), Min3(rootKey), P4(rootKey), Dim5(rootKey), Dim7(rootKey)]
    ...
    case .dim11_b13_add_ma7: // [0, 2, 3, 5, 6, 8, 9, 11]
      return [root, Maj9(rootKey), Min3(rootKey), P4(rootKey), Dim5(rootKey), Min6(rootKey), Dim7(rootKey), Maj7(rootKey)]
