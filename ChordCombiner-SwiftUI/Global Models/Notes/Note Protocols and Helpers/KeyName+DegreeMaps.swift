...
extension KeyName {
  static let zeroMapSharp: [Degree: KeyName] = [
    ...
    .minor9th: KeySwitcher.sharp.minor9th(rootNumber: .zero),
    ...
    .diminished12th: KeySwitcher.sharp.dim5th(rootNumber: .zero),
  ...
  static let zeroMapFlat: [Degree: KeyName] = [
    ...
    .minor9th: KeySwitcher.flat.minor9th(rootNumber: .zero),
    ...
    .diminished12th: KeySwitcher.flat.dim5th(rootNumber: .zero),
