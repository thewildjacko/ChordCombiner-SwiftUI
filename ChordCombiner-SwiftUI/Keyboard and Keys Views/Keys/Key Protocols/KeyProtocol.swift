...
protocol KeyProtocol {
  ...
  init(pitch: Int, keyType: KeyType, note: Note?, baseWidth: CGFloat, widthDivisor: CGFloat, keyPosition: CGFloat, fill: Color, stroke: Color, lineWidth: CGFloat, initialKey: Bool, finalKey: Bool, lettersOn: Bool, circlesOn: Bool, circleType: KeyCircleType)
