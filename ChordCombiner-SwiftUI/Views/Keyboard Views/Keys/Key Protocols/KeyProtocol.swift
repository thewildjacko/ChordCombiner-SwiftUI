...
protocol KeyProtocol {
  ...
  init(pitch: Int, keyType: KeyType, geoWidth: CGFloat, widthMod: CGFloat, fill: any ShapeStyle, stroke: Color, lineWidth: CGFloat)
}
...
extension KeyProtocol {
  ...
  init(pitch: Int, _ keyType: KeyType = .C, geoWidth: CGFloat, widthMod: CGFloat = 23, fill: any ShapeStyle, stroke: Color = .black, lineWidth: CGFloat = 1, initialKey: Bool = false, finalKey: Bool = false, keyPosition: CGFloat = 0) {
    self.init(pitch: pitch, keyType: keyType, geoWidth: geoWidth, widthMod: widthMod, fill: fill, stroke: stroke, lineWidth: lineWidth)
  ...
  init(pitch: Int, _ keyType: KeyType = .C, geoWidth: CGFloat, widthMod: CGFloat = 23, initialKey: Bool = false, finalKey: Bool = false, keyPosition: CGFloat = 0) {
    self.init(pitch: pitch, keyType: keyType, geoWidth: geoWidth, widthMod: widthMod, fill: keyType.defaultFillColor, stroke: .black, lineWidth: 1)
