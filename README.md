...
Another example: two `Note`s have both a **`NoteNumber`** of **`.ten`** and a `Degree` of **`.major3rd`**; however, one's **`Accidental`** is **`.flat`** and the other's is **`.sharp`**. The first will display as **"B♭"** and the second will display as **"A♯"**.
